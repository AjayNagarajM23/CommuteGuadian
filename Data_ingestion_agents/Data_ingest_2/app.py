...
from Agents.Sub_Agent.agent import root_agent
...
async def query_agent(
    ...
    try:
        ...
        try:
            ...
            # Create an instance of CityAnomalyReport from the parsed dictionary
            final_response = CityAnomalyReport(**parsed_json)
